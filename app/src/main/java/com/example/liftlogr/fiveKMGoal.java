...
public class fiveKMGoal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_five_kmgoal);

        timerTextView = findViewById(R.id.timerTextView);
        startButton = findViewById(R.id.button3);
        backButton = findViewById(R.id.backButton5k);
        ...
        backButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new
                                Intent(fiveKMGoal.this, Cardio.class);
                        startActivity(i);
                    }
                }
